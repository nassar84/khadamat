...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        CreateMap<Service, ServiceDto>()
            ...
            .ForMember(d => d.CategoryName, opt => opt.MapFrom(s => s.Category != null ? s.Category.Name : (s.SubCategory != null && s.SubCategory.Category != null ? s.SubCategory.Category.Name : string.Empty)))
