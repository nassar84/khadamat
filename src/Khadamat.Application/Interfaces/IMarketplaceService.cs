...
public interface IMarketplaceService
{
    ...
    Task<IReadOnlyList<MarketplaceItemDto>> SearchItemsAsync(string? query, int? categoryId, int? cityId, string? condition, decimal? minPrice, decimal? maxPrice, string? sellerId = null, int page = 1, int pageSize = 12);
