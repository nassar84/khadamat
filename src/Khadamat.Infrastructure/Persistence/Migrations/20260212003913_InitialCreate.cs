        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxServicesPerProvider = table.Column<int>(type: "int", nullable: false),
                    EnableReviewAutoApproval = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetGovernorates = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TargetCities = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TargetServices = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TargetUserGender = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TargetDays = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TargetMonths = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TargetTimeStart = table.Column<TimeOnly>(type: "time", nullable: true),
                    TargetTimeEnd = table.Column<TimeOnly>(type: "time", nullable: true),
                    TargetKeywords = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_ProviderProfiles_ProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Work_Days = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Work_Houers = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
